...
namespace ExercicioCrudBanco.DAO
{
    ...
    public class Banco
    {
        private static string _strCon = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\vlnote15\Desktop\Guilherme\CRUD PRONTO\DAO\Banco.mdf;Integrated Security=True";
